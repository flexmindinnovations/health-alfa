...
const defaultApiConfig = {
  ...
  clients: {
    ...
    updateUserImage: (id) =>
      `/ClientPersonalInfo/UpdateProfileImage?ClientId=${id}`,
  ...
  doctors: {
    ...
    getAvailabilityById: (doctorId) =>
      `/DoctorTiming/GetDoctorTimingByDoctorId/${doctorId}`,
    updateAvailability: (doctorTimingId) =>
      `/DoctorTiming/updateDoctorTiming/${doctorTimingId}`,
    updateDoctorImage: (id) =>
      `/Doctor/UpdateDoctorProfileImage?doctorId=${id}`,
    save: `/Doctor/SignUp`,
    getDoctorTimingByDoctorIdAndDayWise: (doctorId, dayName) =>
      `/DoctorTiming/GetDoctorTimingByDoctorIdAndDayWise?doctorId=${doctorId}&dayName=${dayName}`,
    saveDoctorAvailability: `/DoctorTiming/saveDoctorTiming`,
    updateDoctorAvailability: `DoctorTiming/updateDoctorTiming`,
    getTimeSlots: (doctorId, dayOfWeek, requestedDate) =>
      `/DoctorTiming/GetTimeSlots/${doctorId}/${dayOfWeek}/${requestedDate}`,
  ...
  appointment: {
    ...
    getAppointmentDetailsById: (appointmentId) =>
      `/Appointment/GetAppointmentDetailsById/${appointmentId}`,
    getAppointmentListByPatientIdId: (patientId) =>
      `/Appointment/GetAppointmentListByPatientIdWise/${patientId}`,
    getAppointmentListByDoctorId: (doctorId) =>
      `/Appointment/GetAppointmentListByDoctorIdWise/${doctorId}`,
