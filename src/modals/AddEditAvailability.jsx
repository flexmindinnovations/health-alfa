...
import {ActionIcon, Box, Button, CloseIcon, Group, Select, Stack, Title, useMantineTheme} from '@mantine/core';
...
const convertTimeFormat = (inputTime) => {
    ...
    return dayjs(`${currentDate} ${inputTime}`, "h:mm A").format("HH:mm:ss");
}
