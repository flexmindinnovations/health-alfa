...
const contactDetails = [
  {
    title: "questionsLetsStartTheConversation",
    email: "info@healthalpha.ae",
    icon: Mail,
    description: "questionsLetsStartTheConversationDescription",
  },
  {
    title: "hereForYouAroundTheClock",
    email: "support @healthalpha.ae",
    icon: MessageCircle,
    description: "hereForYouAroundTheClockDescription",
  },
  {
    title: "ShapetheFutureofHealthAlpha",
    email: "feedback@healthalpha.ae",
    icon: Edit3,
    description: "ShapetheFutureofHealthAlphaDescription",
  },
  {
    title: "collaborateforaHealthierTomorrow",
    email: "partnerships@healthalpha.ae",
    icon: Handshake,
    description: "collaborateforaHealthierTomorrowDescription",
  },
];
...
const ContactCard = ({ title, icon: Icon, email, description }) => (
  ...
  >
    <Stack justify="space-between" h="100%" w={"100%"}>
      ...
      <Anchor href={`mailto:${email}`} size="sm" fw={500} ta={"center"}>
        {email}
      </Anchor>
    </Stack>
  </Card>
  ...
  return (
    <Container fluid style={{ ...utils.dotsBackground }}>
      <Stack
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(255,255,255,0) 0px, #f4fdfc 300px, #f4fdfc 100%)",
          minHeight: "100vh",
        }}
      >
        ...
        <Box
          component="section"
          className="relative w-full bg-gradient-to-r from-tb-900 to-tb-600 text-white py-20 px-6 text-center"
        >
