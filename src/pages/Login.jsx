...
export default function Login() {
    ...
    const openConditionModals = (src) => {
        openModal({
            Component: src === 'terms' ? TermsAndConditions : PrivacyPolicy,
            data: null,
            isAddEdit: false,
            title: src === 'terms' ? t('termsAndConditions') : t('privacyPolicy'),
            closable: true,
            size: 'xl',
            titleprops: { fontSize: '18px', fontWeight: 'bold' }
        });
    }
                                            ...
                                            <Stack my={20} gap={10}>
                                                ...
                                                <Center className='w-full'>
                                                    <Text size='xs' className='opacity-70'
                                                        ...
                                                        <Anchor
                                                            onClick={openConditionModals.bind(this, 'terms')}
                                                            underline='always' c={theme.colors.brand[1]} size='xs'>
                                                            Terms of Services
                                                        </Anchor>
                                                        &nbsp; and &nbsp;
                                                        <Anchor
